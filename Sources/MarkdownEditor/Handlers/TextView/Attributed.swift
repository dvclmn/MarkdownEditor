...
//  
//  func replaceCharacters(in range: NSTextRange, with attributedString: NSAttributedString) {
...
//    let nsRange: NSRange = .init(range, in: contentManager)
//    
//    storage.replaceCharacters(in: nsRange, with: attributedString)
//    
//    didChangeText()
//  }
//  
